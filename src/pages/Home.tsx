...
const Home: React.FC = () => {
  ...
  const upcomingEvents = [
    {
      id: 1,
      title: "React ao LTA SUL - Final",
      date: "28 de Maio, 2025",
      time: "13:00",
      type: "React",
      image: "/assets/images/lta.jpg" // Volte para o caminho original
    },
    {
      id: 2,
      title: "Valorant com as Lendas",
      date: "30 de Maio, 2025",
      time: "19:00",
      type: "Gameplay",
      image: "/assets/images/vava.jpg" // Volte para o caminho original
    },
    {
      id: 3,
      ...
      time: "20:00",
      type: "Especial",
      image: "/assets/images/showmatch.jpg" // Volte para o caminho original
    }
  ];
  ...
  return (
    <div className="overflow-hidden">
            ...
            <motion.div variants={itemVariants}>
              <div className="relative">
                ...
                <div className="w-full aspect-[16/9] overflow-hidden rounded-lg">
                  <img
                    src="/assets/images/lendas.jpg" // Volte para o caminho original
            ...
            {upcomingEvents.map((event, index) => (
              ...
              >
                <div className="relative h-48">
                  ...
                  {/* Remova a div de background roxo se ela estiver sobrepondo a imagem */}
                  {/* <div className="w-full h-full bg-background-purple"></div> */}
                  <img
                    src={event.image} // Volte para o caminho original
                    alt={event.title}
                    className="w-full h-full object-cover"
                  />
                ...
                <div className="p-6">
                  ...
                  <motion.a
                    href="/calendario"
                    className="bg-gradient-button w-full text-center inline-block py-2 px-4 rounded-lg text-white"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    Ver Detalhes
      ...
      <motion.section
        ...
        className="py-20 bg-gradient-button"
      >
        <div className="container mx-auto px-4 md:px-6">
