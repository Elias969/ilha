    ...
    >
      <div className="container mx-auto px-4 md:px-6">
        <motion.div variants={itemVariants} className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Nossos <span className="text-gradient">Canais</span></h1>
        ...
        <motion.div variants={itemVariants} className="flex justify-center mb-8">
          <div className="bg-background-purple/30 p-2 rounded-lg inline-flex">
            <button 
              className={`px-4 py-2 rounded-lg transition-all duration-300 ${activeTab === 'todos' ? 'bg-gradient-button text-white' : 'text-gray-300 hover:text-white'}`}
              onClick={() => setActiveTab('todos')}
            >
              Todos
            </button>
            <button 
              className={`px-4 py-2 rounded-lg transition-all duration-300 ${activeTab === 'oficiais' ? 'bg-gradient-button text-white' : 'text-gray-300 hover:text-white'}`}
              onClick={() => setActiveTab('oficiais')}
            >
              Canais Oficiais
            </button>
            <button 
              className={`px-4 py-2 rounded-lg transition-all duration-300 ${activeTab === 'membros' ? 'bg-gradient-button text-white' : 'text-gray-300 hover:text-white'}`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {getCanaisFiltrados().map((canal) => (
            ...
            >
              ...
              <div className="flex items-center text-primary-lime">
        ...
        <motion.div variants={itemVariants} className="mt-16 text-center">
          <h2 className="text-2xl font-bold mb-4">Não perca <span className="text-gradient">nenhuma atualização</span></h2>
          <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
            Ative as notificações em todos os nossos canais para ser avisado sempre que um novo conteúdo for ao ar.
          </p>
          
          <div className="bg-gradient-highlight p-8 rounded-lg max-w-3xl mx-auto">
